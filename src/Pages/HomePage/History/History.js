...
const History = () => {
    return (
        <section className="p-6 pb-24 lg:px-20 py-6 bg-gradient-to-l from-black via-slate-800 to-gray-900 pt-12 text-gray-200">
            <div className="mb-5 mt-12">
                <h2 className="text-black text-3xl text-green-400 font-bold mb-5">Short Overview</h2>
                <p className="text-gray-200 text-base font-semibold py-5">When starting a business, one key task is to create a business plan that outlines your goals and how you aim to achieve them. Your business overview is a necessary section that presents these ideas more broadly and provides your audience with background information about your company.</p>
            </div>
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                <div className="flex p-4 pb-10 space-x-4 rounded-lg md:space-x-6 bg-gradient-to-t from-blue-900 via-slate-900 to-violet-700 text-gray-100">
