...
const Advertise = ({ advertiseProducts }) => {
    return (
        <div className="pb-16 lg:px-12 bg-gradient-to-l from-black via-slate-800 to-gray-900 pt-12">
            <h2 className="font-bold text-lime-400 text-3xl mt-12 mb-5">Available collections!!!</h2>
