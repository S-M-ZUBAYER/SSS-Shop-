...
const ReviewCard = () => {
    return (
        <div className=" bg-gradient-to-t from-blue-900 via-slate-900 to-violet-700 text-gray-200 my-5 mx-5">
            <img
                alt="Woman"
                src="https://tse3.mm.bing.net/th?id=OIP.dOlCOdj-6A53DrMP5QhhTAHaEK&pid=Api&P=0"
            ...
            >
                ...
                <p className="mt-4 text-sm ">
                    Details review about the product Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis eius omnis incidunt!
                </p>
