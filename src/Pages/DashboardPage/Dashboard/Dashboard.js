    ...
    return (
        <div>
            ...
            <div className="drawer drawer-mobile">
                ...
                <div className="drawer-content bg-gradient-to-l from-black via-slate-800 to-gray-900">
                    <Outlet></Outlet>


                </div>
                <div className="drawer-side text-gray-200 font-bold text-xl bg-gradient-to-l from-black via-slate-800 to-gray-900">
                    ...
                    <ul className="menu p-4 w-80 ">
                        ...
                        {users?.accountType === "Buyer" && !isAdmin &&
                            <>
                                ...
                                <li><Link to='/dashboard/wishList'>Cart</Link></li>
                            </>
                        }
