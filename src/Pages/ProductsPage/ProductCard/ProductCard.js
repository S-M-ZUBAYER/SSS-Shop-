...
const ProductCard = ({ product, setBookingProduct }) => {
    ...
    const { name, productName, image, sellerImg, price, date, quality, condition, phone, sellReason, location, description, originalPrice, duration } = product;
    return (
        <div>
            <div className="flex flex-col max-w-lg p-6 bg-gradient-to-t from-slate-700 via-green-900 to-gray-700  overflow-hidden rounded-lg shadow-md text-gray-200">
                ...
                <div className="flex justify-between w-full mb-3">
                    ...
                    <p className="text-base mr-3">Price: {price}$</p>
                </div>
                ...
                <div className="flex justify-between mt-4">
                    ...
                    <label
                        ...
                        className="btn bg-yellow-300 text-black w-1/3 py-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 pr-1">
                    ...
                    <label
                        ...
                        onClick={() => setBookingProduct(product)}
                        className="btn bg-yellow-300 text-black w-1/3 py-2 ">Details</label>
